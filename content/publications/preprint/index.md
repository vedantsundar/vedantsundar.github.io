...
summary: This investigation aims to conduct a Finite-Element Method (FEM) analysis of an ultrasonic detection array setup via simulations of a complete thermoacoustic model on the COMSOL® Multiphysics 6.1 software to confirm phase modulation of an ultrasonic signal for the development of a primary standard for Absolute Dosimetry and technology to conduct real-time imaging of absorbed radiation dose.
